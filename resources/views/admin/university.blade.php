            ...
            <div class="card-body {{ $ft == 'edit' ? '' : 'hide-this' }}" id="tblCDiv">
              ...
              <form action="{{ $url }}/" class="needs-validation" method="post" enctype="multipart/form-data"
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-sm-12 mb-3">
                    <x-InputField type="text" label="URL" name="uname" id="uname" :ft="$ft"
                      :sd="$sd">
                    </x-InputField>
                  </div>
                  ...
                  <div class="col-md-3 col-sm-12 mb-3" id="uploadBroDiv">
                    <x-InputField type="file" label="Brochure" name="brochure" id="brochure" :ft="$ft"
                      :sd="$sd">
                    </x-InputField>
                  </div>
                  <div class="col-md-2 col-sm-12 mb-3 setBtn" id="insertLinkBtn">
                  ...
                  <div class="col-md-3 col-sm-12 mb-3 hide-this" id="insertLinkDiv">
                    <x-InputField type="text" label="Enter Link" name="brochure_path" id="brochure_path"
                      :ft="$ft" :sd="$sd">
                    </x-InputField>
                  </div>
                  <div class="col-md-2 col-sm-12 mb-3 setBtn hide-this" id="uploadBroBtn">
                  ...
                  <div class="col-md-3 col-sm-12 mb-3" id="uploadBroDiv">
                    <x-InputField type="file" label="Upload Overview Page Image" name="overview_image"
                      id="overview_image" :ft="$ft" :sd="$sd">
                    </x-InputField>
                  </div>
                  <div class="col-md-12 col-sm-12 mb-3" id="uploadBroDiv">
                    <x-textarea-field label="Enter Overview" name="overview" id="overview" :ft="$ft"
                      :sd="$sd">
                    </x-textarea-field>
                  </div>
                </div>
            ...
            <div class="card-body">
              <form class="needs-validation" method="get" novalidate>
                <div class="row">
                  ...
                  <div class="col-md-6 col-sm-12 mb-3">
                    <a href="{{ aurl($page_route) }}" class="btn btn-sm btn-info col-btn setBtn"><i
                        class="ti-trash"></i>
                      Reset</a>
                    <button class="btn btn-sm btn-primary col-btn setBtn" type="submit">Submit</button>
                  </div>
                </div>
                ...
                <tbody>
                  @foreach ($rows as $row)
                    <tr id="row{{ $row->id }}">
                      ...
                      <td>
                        Logo : @if ($row->imgpath != null)
                          <a href="{{ asset($row->imgpath) }}"> view </a>
                        @else
                          <small>N/A</small>
                        @endif
                        <br>
                        Banner : @if ($row->bannerpath != null)
                          <a href="{{ asset($row->bannerpath) }}"> view </a>
                        @else
                          <small>N/A</small>
                        @endif
                        <br>
                        Overview Image : @if ($row->overview_image != null)
                          <a href="{{ asset($row->overview_image) }}"> view </a>
                        @else
                          <small>N/A</small>
                        @endif
                      </td>
                      ...
                      <td>
                        <x-content-view-modal :row="$row" field="overview" title="Overview" />
                      </td>
                      <td>
