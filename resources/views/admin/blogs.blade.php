            ...
            <div class="card-body {{ $ft == 'edit' ? '' : 'hide-this' }}" id="tblCDiv">
              <form action="{{ $url }}/" class="needs-validation" method="post" enctype="multipart/form-data"
                ...
                <div class="row">
                  ...
                  <div class="col-md-3 col-sm-12 mb-3">
                    <x-SelectField label="University" name="u_id" id="u_id" savev="id" showv="name"
                      :list="$universities" :ft="$ft" :sd="$sd"></x-SelectField>
                  </div>
                  <div class="col-md-3 col-sm-12 mb-3">
                  ...
                  <div class="col-md-12 col-sm-12 mb-3">
                    <x-InputField type="text" label="Headline" name="headline" id="headline" :ft="$ft"
                      :sd="$sd"></x-InputField>
                  </div>
                  <div class="col-md-12 col-sm-12 mb-3">
                ...
                <tbody>
                  ...
                  @foreach ($rows as $row)
                    ...
                    <tr id="row{{ $row->id }}">
                      <td>{{ $i }}</td>
                      <td>
                        Category : {{ $row->getCategory->cate_name }} <br>
                        Author : {{ $row->getAuthor->name ?? 'Null' }}
                      </td>
                      <td>{{ $row->headline }}</td>
                      <td>
