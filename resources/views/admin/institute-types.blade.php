            ...
            <form action="{{ $url }}/" class="needs-validation" method="post" enctype="multipart/form-data" novalidate>
              ...
              <div class="row">
                <div class="col-md-3 col-sm-12 mb-3">
                  <x-InputField type="text" label="Enter Institute Type" name="type" id="type" :ft="$ft" :sd="$sd"></x-InputField>
                </div>
                <div class="col-md-3 col-sm-12 mb-3">
                  <x-InputField type="text" label="Enter Institute Type Seo Name" name="seo_title" id="seo_title" :ft="$ft" :sd="$sd"></x-InputField>
                </div>
              </div>
