            ...
            <form action="{{ $url }}/" class="needs-validation" method="post" enctype="multipart/form-data" novalidate>
              ...
              <div class="row">
                <div class="col-md-4 col-sm-12 mb-3">
                  <x-InputField type="text" label="Program" name="program" id="program" :ft="$ft" :sd="$sd"></x-InputField>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 col-sm-12 mb-3">
                  <x-TextareaField label="Application Deadline" name="application_deadline" id="application_deadline" :ft="$ft" :sd="$sd"></x-TextareaField>
                </div>
                <div class="col-md-6 col-sm-12 mb-3">
                  <x-TextareaField label="Fees" name="fees" id="fees" :ft="$ft" :sd="$sd"></x-TextareaField>
                </div>
              </div>
              @if ($ft == 'add')
