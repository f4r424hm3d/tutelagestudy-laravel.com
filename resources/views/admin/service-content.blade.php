    ...
    <div class="row">
      <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
          <h4 class="mb-sm-0 font-size-18">{{ $page_title }} <span class="text-danger">({{ $service->title }})</span></h4>
            ...
            <form action="{{ $url }}/" class="needs-validation" method="post" enctype="multipart/form-data" novalidate>
              ...
              <div class="row">
                ...
                <div class="col-md-12 col-sm-12 mb-3">
                  <x-TextareaField label="Decription" name="description" id="description" :ft="$ft" :sd="$sd"></x-TextareaField>
                </div>
              </div>
              @if ($ft == 'add')
              ...
              <tbody>
                ...
                <tr id="row{{ $row->id }}">
                  ...
                  <td>
                    ...
                    <a href="{{ url('admin/'.$page_route.'/'.$service->id.'/update/' . $row->id) }}"
