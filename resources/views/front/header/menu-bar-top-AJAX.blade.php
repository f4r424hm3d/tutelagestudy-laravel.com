...
<body>
  ...
  <div class="ps-panel--sidebar" id="navigation-mobile">
    ...
    <div class="ps-panel__content">
      ...
      @error('captcha')
        <span class="text-danger">{{ $message }}</span>
      @enderror
      <form action="{{ url('inquiry/download-brochure') }}/" method="post" id="downloadBrochureForm">
        @csrf
                ...
                <div class="row">
                  <div class="col-sm-5">
                    <div class="form-group">
                      ...
                      <span class="text-danger" id="name-err-b">
                        @error('name')
                          {{ $message }}
                        @enderror
                      </span>
                  ...
                  <div class="col-sm-7">
                    <div class="form-group">
                      ...
                      <span class="text-danger" id="email-err-b">
                        @error('email')
                          {{ $message }}
                        @enderror
                      </span>
                ...
                <div class="row">
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <span class="text-danger" id="c_code-err-b">
                        @error('c_code')
                          {{ $message }}
                        @enderror
                      </span>
                  ...
                  <div class="col-sm-9">
                    <div class="form-group">
                      ...
                      <span class="text-danger" id="mobile-err-b">
                        @error('mobile')
                          {{ $message }}
                        @enderror
                      </span>
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl7">
                    ...
                    <span class="text-danger" id="captcha-err-b">
                      @error('captcha')
                        {{ $message }}
                      @enderror
                    </span>
  ...
  <script>
    ...
    $(document).ready(function() {
      $('#downloadBrochureForm').on('submit', function(event) {
        event.preventDefault();
        $(".errSpan").text('');
        $.ajax({
          url: "{{ url('inquiry/download-brochure') }}/",
          method: "POST",
          ...
          success: function(data) {
            ...
            if (data.hasOwnProperty('success')) {
              ...
              // Check if the error is due to CAPTCHA validation failure
              if (data.error.hasOwnProperty('captcha')) {
                // Handle CAPTCHA validation failure error
