...
<body>
		...
		<div class="ps-panel--sidebar" id="search-sidebar">
				...
				<div class="navigation__content">
                    ...
                    ?>
																						<option value="<?php echo $row->phonecode; ?>" <?php echo (old('c_code') && old('c_code') == $row->phonecode) || $row->phonecode == 91 ? 'Selected' : ''; ?>> +
                    ...
                    ?>
																						<option value="<?php echo $row->name; ?>" <?php echo old('nationality') == $row->name || $row->name == 'INDIA' ? 'Selected' : ''; ?>>
																								<?php echo $row->name; ?>
																						</option>
																						<?php } ?>
																				</select>
