...
<head>
  ...
  <meta property="og:image" content="<?php echo base_url($author->profile_pic_path); ?>" />
  <meta property="og:image:secure_url" content="<?php echo base_url($author->profile_pic_path); ?>" />
