          ...
          <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
            <div class="ps-post--detail sidebar">
              <div class="ps-post__content card">
                ...
                <div>
                  <img src="{{ cdn($service->imgpath) }}" alt="{{ ucfirst($service->headline) }}" class="mb-20"
                    width="1000">
                </div>
                <br>
                ...
                <aside class="widget widget_best-sale" data-mh="dealhot">
                  ...
                  <div class="widget__content">
                    <div class="owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000"
                      data-owl-gap="0" data-owl-nav="false" data-owl-dots="false" data-owl-item="4" data-owl-item-xs="2"
                      data-owl-item-sm="2" data-owl-item-md="4" data-owl-item-lg="4" data-owl-duration="1000"
                      ...
                      <div class="ps-product-group">
                        <div class="ps-product--horizontal">
                          <div class="ps-product__thumbnail ml-10" style="background:#fff">
                            <img src="<?php echo cdn($oe->thumbnail); ?>" alt="<?php echo $oe->page_name; ?>">
                          </div>
