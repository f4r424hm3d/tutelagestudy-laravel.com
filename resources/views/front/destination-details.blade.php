...
<style>
  ...
  .ps-carousel--nav .owl-nav .owl-next {
    ...
    <!--<div class="ps-search-trending"> <div class="container"> <div class="ps-section__header text-center"> <h3 style="color:white">Most Popular Countries for MBBS Abroad</h3> <small style="color:white">With Tutelage Study you can get MBBS Abroad Admission in world top Medical Universities</small> </div> <div class="row"> <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12"> <div class="ps-post ps-product shadow"> <div class="ps-post__thumbnail"><img data-src="{{ asset('/front/') }}/img/mbbs-malaysia.jpg" alt="MBBS Malaysia"></div> <div class="ps-post__content" style="border:0px; padding:12px 0px; background:#fff"> <a class="ps-post__title text-center" href="https://www.tutelagestudy.com/mbbs-in-malaysia/">MBBS MALAYSIA</a> </div> </div> </div> <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12"> <a href="https://www.tutelagestudy.com/mbbs-in-russia/"> <div class="ps-post ps-product shadow"> <div class="ps-post__thumbnail"><img data-src="{{ asset('/front/') }}/img/mbbs-russia.jpg" alt="MBBS russia"> </div> <div class="ps-post__content" style="border:0px; padding:12px 0px; background:#fff"> <div class="ps-post__title text-center">MBBS IN RUSSIA</div> </div> </div> </a> </div> <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12"> <div class="ps-post ps-product shadow"> <div class="ps-post__thumbnail"><img data-src="{{ asset('/front/') }}/img/mbbs-mauritius.jpg" alt="MBBS Mauritius"></div> <div class="ps-post__content" style="border:0px; padding:12px 0px; background:#fff"> <a href="https://www.tutelagestudy.com/mbbs-in-mauritius/" class="ps-post__title text-center">MBBS MAURITUS</a> </div> </div> </div> <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12"> <div class="ps-post ps-product shadow"> <div class="ps-post__thumbnail"><img data-src="{{ asset('/front/') }}/img/mbbs-iran.jpg" alt="MBBS Iran"></div> <div class="ps-post__content" style="border:0px; padding:12px 0px; background:#fff"> <a href="https://www.tutelagestudy.com/mbbs-in-iran/" href="https://www.tutelagestudy.com/mbbs-in-iran/" class="ps-post__title text-center">MBBS IRAN</a> </div> </div> </div> <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12"> <div class="ps-post ps-product shadow"> <div class="ps-post__thumbnail"><img data-src="{{ asset('/front/') }}/img/mbbs-vietnam.jpg" alt="MBBS Vietnam"> </div> <div class="ps-post__content" style="border:0px; padding:12px 0px; background:#fff"> <a href="https://www.tutelagestudy.com/mbbs-in-vietnam/" class="ps-post__title text-center">MBBS VIETNAM</a> </div> </div> </div> <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12"> <div class="ps-post ps-product shadow"> <div class="ps-post__thumbnail"><img data-src="{{ asset('/front/') }}/img/mbbs-cyprus.jpg" alt="MBBS Cyprus"> </div> <div class="ps-post__content" style="border:0px; padding:12px 0px; background:#fff"> <a href="https://www.tutelagestudy.com/mbbs-in-cyprus/" class="ps-post__title text-center">MBBS CYPRUS</a> </div> </div> </div> <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12"> <div class="ps-post ps-product shadow"> <div class="ps-post__thumbnail"><img data-src="{{ asset('/front/') }}/img/mbbs-belarus.jpg" alt="MBBS Belarus"> </div> <div class="ps-post__content" style="border:0px; padding:12px 0px; background:#fff"> <a href="https://www.tutelagestudy.com/mbbs-in-belarus/" class="ps-post__title text-center">MBBS BELARUS</a> </div> </div> </div> <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12"> <div class="ps-post ps-product shadow"> <div class="ps-post__thumbnail"><img data-src="{{ asset('/front/') }}/img/mbbs-bangladesh.jpg" alt="MBBS Bangladesh"></div> <div class="ps-post__content" style="border:0px; padding:12px 0px; background:#fff"> <a href="https://www.tutelagestudy.com/mbbs-in-bangladesh/" class="ps-post__title text-center">MBBS BANGLADESH</a> </div> </div> </div> </div> <div class="pt-20" align="center"><a href="/destinations/" target="_blank" rel="noopener noreferrer" class="button home-btn">Browse MBBS Countries</a></div> </div> </div> -->
    </div>
    <script>
