...
<div class="ps-page--single ps-page--vendor">
  ...
  <div class="ps-page--blog widget_features">
    <div class="ps-page__right mb-30">
      <div class="row">
        ...
        <div class="mb-20 col-md-9">
          <div class="ps-post--detail sidebar">
            <div class="ps-post__content card">
              ...
              <div>
                <img src="<?php echo asset($blog->imgpath) ?>" alt="<?php echo ucfirst($blog->headline); ?>" class="mb-20" width="1000">
              </div>
             <br>
             <div class="pt-0 pb-20 get-detail">
              <h4 class="mb-0">Get Free Counselling</h4>
                <a class="ps-btn"  onclick="window.location.href='<?php echo url('mbbs-abroad-counselling/'); ?>'" href="javascript:void()">Enquire Now</a>
              </div>
              <hr>
              ...
              <div class="ps-section--default pb-2" style="margin-bottom:0px">
                <div class="ps-section__header" style="margin-bottom:0px; padding-bottom:0px; border:0px">
                  <div class="row author">
                    <div class="col-md-2">
                      <div class="img-div">
                        <img src="<?php echo asset($blog->getAuthor->profile_pic_path); ?>" alt="<?php echo $blog->getAuthor->name; ?>"><i class="fa fa-check-circle"></i>
                      </div>
                    </div>
                    <div class="col-md-10">
                      <div class="cont-div">
                        <h6>{{ $blog->getAuthor->name }}</h6>
                        <span>Content Curator | Updated on - <?php echo getFormattedDate($blog->updated_at,'M d, Y'); ?></span>
                        <?php if($blog->getAuthor->shortnote!=null){ ?>
                          <p><?php echo $blog->getAuthor->shortnote; ?></p><br>
                        <?php } ?>
                        <a style="float:right" href="<?php echo url('author/'.$blog->getAuthor->slug); ?>/" class="bio-btn">Read Full Bio</a>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="col-md-3">
          <div class="ps-section__left">
            <aside class="ps-widget--account-dashboard">
              <h3 style=" background:#cd2122; color:#fff; font-size:16px; padding:10px 20px; margin:0px">More Categories</h3>
            ...
            <aside class="ps-widget--account-dashboard">
              <h3 style=" background:#cd2122; color:#fff; font-size:16px; padding:10px 20px; margin:0px">Recent Posts</h3>
              <div class="ps-widget__content" style="background:#fff">
                <ul>
                  <?php
                  foreach ($blogs as $rn) {
                  ?>
                    <li><a href="<?php echo url($rn->slug); ?>/"><i class="icon-arrow-right"></i> <?php echo ucwords($rn->headline); ?></a></li>
                  <?php } ?>
                </ul>
              </div>
            </aside>
            ...
            <aside class="ps-widget--account-dashboard">
              <h3 style=" background:#cd2122; color:#fff; font-size:16px; padding:10px 20px; margin:0px">Destinations</h3>
              <div class="ps-widget__content" style="background:#fff">
                <ul>
