														...
														<div class="ps-post__content card">
																<div class="ps-post__header">
																		...
																		<p style="font-size:12px">
																				<?php echo getFormattedDate($blog->created_at, 'd M, Y'); ?>, <b>By Tutelage Team</b>, <a href="<?php echo url('category/' . $blog->cate_slug); ?>/">
																...
																<div class="pt-0 pb-20 get-detail">
																		...
																		<a class="ps-btn" onclick="window.location.href='<?php echo url('mbbs-abroad-counselling/'); ?>'" href="javascript:void()">Enquire
																				Now</a>
																</div>
																<hr>
