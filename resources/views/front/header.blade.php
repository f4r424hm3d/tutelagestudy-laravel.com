...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-T4ZDHCD"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<!-- End Google Tag Manager (noscript) -->
  <script src="https://www.google.com/recaptcha/api.js?render=6LdZ40kfAAAAAJxc-2LXIFDQhBTdC2KLLekMtgSd"></script>
          ...
          <div class="menu--product-categories">
            ...
            <div class="menu__content">
              <ul class="menu--dropdown">
                ...
                ?>
                  <li class="current-menu-item"><a href="<?php echo base_url('blog/' . $cat->cate_slug); ?>"><i class="icon-star"></i> <?php echo ucwords(str_replace('-', ' ', $cat->cate_slug)); ?></a></li>
                <?php } ?>
              </ul>
            </div>
          </div>
          <a class="ps-logo" href="<?php echo base_url(); ?>"><img src="<?php echo base_url('assets/web/'); ?>img/logo_light.png" alt="indian universities logo"></a>
        </div>
              ...
              <ul class="menu--dropdown">
                ...
                ?>
                  <li class="current-menu-item">
                    <a href="<?php echo base_url('category/' . $cat->cate_slug); ?>/"><i class="icon-star"></i> <?php echo ucwords(str_replace('-', ' ', $cat->cate_slug)); ?></a>
                  </li>
                <?php } ?>
              </ul>
            </div>
              ...
              <div class="mega-menu">
                <div class="mega-menu__column">
                  ...
                  <ul class="mega-menu__list">
                    ...
                    foreach ($tu as $tu) {
                    ?>
                      <li class="current-menu-item "><a target="_blank" href="<?php echo base_url($tu->country_slug . '/' . $tu->uname); ?>/"><?php echo $tu->name; ?></a> </li>
                    <?php } ?>
                  </ul>
                </div>
                <div class="mega-menu__column">
                  ...
                  <ul class="mega-menu__list">
                    ...
                    ?>
                      <li class="current-menu-item ">
                        <a target="_blank" href="<?php echo base_url($tu->country_slug . '/' . $tu->uname); ?>/"><?php echo $tu->name; ?></a>
                      </li>
                    <?php } ?>
                    <br>
              ...
              <div class="mega-menu">
                <div class="mega-menu__column">
                  <ul class="mega-menu__list">
                    ...
                    ?>
                      <li class="current-menu-item"><a href="<?php echo base_url($row->slug); ?>/"><?php echo ucwords($row->page_name); ?></a> </li>
                    <?php } ?>
                  </ul>
                </div>
              </div>
        ...
        ?>
          <li class="current-menu-item">
            <a href="<?php echo base_url('category/' . $cat->cate_slug); ?>/">
              <i class="icon-star"></i> <?php echo ucwords(str_replace('-', ' ', $cat->cate_slug)); ?>
            </a>
          </li>
        <?php } ?>
      </ul>
  ...
  <div class="ps-panel--sidebar" id="menu-mobile">
    ...
    <div class="ps-panel__content">
      <ul class="menu--mobile">
          ...
          <div class="mega-menu">
            ...
            <div class="mega-menu__column">
              ...
              <ul class="mega-menu__list">
                ...
                ?>
                  <li class="current-menu-item ">
                    <a href="<?php echo base_url($itslug); ?>/"><?php echo $row->inst_type; ?></a>
                  </li>
                <?php } ?>
              </ul>
            </div>
        ...
        <li class="menu-item-has-children has-mega-menu"> <a href="<?php echo base_url('destinations'); ?>">Destinations</a><span class="sub-toggle"></span>
          <div class="mega-menu">
            <div class="mega-menu__column">
        ...
        <li>
          <a href="<?php echo base_url('compare'); ?>/" class="hidden">Compare Universities</a><span class="sub-toggle"></span>
        </li>
      </ul>
    </div>
  </div>