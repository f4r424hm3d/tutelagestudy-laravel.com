                        ...
                        <div class="ps-product__box">
                          ...
                          <div class="ps-section__content">
                            <form action="{{ url('inquiry/get-brochure') }}/" method="post">
                              @csrf
                              <input type="hidden" name="source" value="Destination Page Sidebar Form">
                ...
                <div class="container-fluid">
                  ...
                  <div class="ps-section__content">
                    <div class="ps-carousel--nav owl-slider" data-owl-auto="true" data-owl-loop="true"
                      ...
                      data-owl-item="3" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="3"
                      data-owl-item-lg="3" data-owl-duration="1000" data-owl-mousedrag="on">
                      <?php foreach ($testimonials as $test) { ?>
                      <div class="ps-block--testimonial pt-3 pb-3 pl-5 pr-5">
                        <div class="ps-block__header">
                          <img src="<?php echo $test->image != null ? asset($test->image) : asset('front/user-tesimonial-photo.jpg'); ?>" alt="MBBS Abroad Testimonial">
                        </div>
