            ...
            <section class="ps-store-box">
              <div class="ps-section__header mt-20">
                ...
                <select class="form-control" style="width:200px; background:#fff" id="newscate">
                  ...
                  <option value="<?php echo $alp->exam_slug; ?>/" <?php echo $exam->exam_slug == $alp->exam_slug ? 'Selected' : ''; ?>>
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12 col-12 ">
                    <div class="ps-post ps-product">
                      ...
                      <div class="ps-post__content">
                        ...
                        <a class="ps-post__title" href="<?php echo url($exam->exam_slug . '/' . $row->slug); ?>/" title="<?php echo $row->page_name; ?>"
                          data-toggle="tooltip">
  ...
  <script>
    $(document).ready(function() {
      $('#newscate').change(function() {
        ...
        window.location.replace("{{ url('/') }}/" + newscate);
      });
    });
  </script>
@endsection
