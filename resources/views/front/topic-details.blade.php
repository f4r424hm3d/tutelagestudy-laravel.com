...
<div class="ps-breadcrumb">
  <div class="ps-container">
    <ul class="breadcrumb bread-scrollbar">
      ...
      <li><a href="<?php echo base_url($lp->exam_slug); ?>/"><?php echo $lp->exam_name ?></a></li>
      <li><?php echo $row->page_name; ?></li>
    </ul>
  </div>
</div>
<!-- header background section ends -->
<div class="header-bg1" style="background:linear-gradient(to right, #215697 0%, #ab2700 100%); padding:5px 1% 15px;display:none">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12 col-sm-12 pt-5 pb-4">
        <h1 class="fcolor"><?php echo $row->page_name; ?> For Indian Students: Fees, Admission, Intake 2023</h1>
          ...
          <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12 mb-20">
            ...
            <div class="ps-product__box">
              <div class="ps-document">
                <center><img src="<?php echo base_url($row->image_path); ?>" alt="<?php echo $row->page_name; ?>" class="img-responsive"></center>
              </div>
              ...
              <aside class="ps-widget--account-dashboard">
                ...
                <div class="ps-widget__content" style="background:#fff">
                  <ul>
                    ...
                    <li><a href="<?php echo base_url($lp->exam_slug.'/' . $row->slug); ?>/"><i class="icon-arrow-right"></i> <?php echo $row->page_name; ?></a></li>
                    <?php } ?>
                  </ul>
                </div>
              </aside>
              ...
              <aside class="ps-widget--account-dashboard">
                <div class="ps-widget__content">
                  ...
                  <ul style="max-height:480px; overflow:auto">
                    ...
                    <li>
                      <a href="<?php echo base_url($row->exam_slug); ?>/"><i class="icon-arrow-right"></i><?php echo $row->exam_name; ?></a>
                    </li>
                    <?php } ?>
                  </ul>
                </div>
      ...
      <div class="modal-header w-100">
        <div class="modal-title row" style="width: inherit;">
          <div class="ps-product__thumbnail universitylogo col-md-2 col-sm-2 col-xs-2 col-3" style="padding-right:0px">
            <img src="<?php echo base_url($row->thumbnail); ?>" class="img-responsive" alt="<?php echo $row->page_name; ?>" style="width: 80px; height:80px; box-shadow:rgb(0 0 0 / 12%) 0 1px 3px, rgb(0 0 0 / 24%) 0 1px 2px; border-radius: 50%; display:flex;align-items:center; padding:5px; float:left; margin:auto">
          </div>
