                ...
                <aside class="ps-widget--account-dashboard">
                  ...
                  <div class="ps-widget__content" style="background:#fff">
                    <ul>
                      ...
                      <li><a href="<?php echo base_url($lp->exam_slug . '/' . $row->slug); ?>/"><i class="icon-arrow-right"></i>
                          <?php echo $row->page_name; ?>
                        </a></li>
                      <?php } ?>
                    </ul>
      ...
      <div class="modal-content">
        <div class="modal-header w-100">
          <div class="modal-title row" style="width: inherit;">
            <div class="ps-product__thumbnail universitylogo col-md-2 col-sm-2 col-xs-2 col-3"
              style="padding-right:0px">
              <img src="<?php echo base_url($row->thumbnail); ?>" class="img-responsive" alt="<?php echo $row->page_name; ?>"
            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="form-group">
                  <input type="email" class="form-control" name="email" id="email"
                    value="<?php echo $old['email']; ?>" placeholder="Enter Email" required>
                  <?php
              ...
              <div class="col-4 col-lg-4 col-md-4 col-sm-4 col-xs-6" style="padding-right:0px">
                <div class="form-group">
                  <select class="form-control" name="c_code" id="c_code" required>
                    ...
                    ?>
                    <option value="<?php echo $row->phonecode; ?>" <?php echo $curCountry == $row->phonecode || $old['c_code'] == $row->phonecode ? 'Selected' : ''; ?>> +
              ...
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                <div class="form-group">
                  <select class="form-control" name="destination" id="destination" required>
                    ...
                    ?>
                    <option value="<?php echo $row->page_name; ?>" <?php echo $old['destination'] == $row->page_name || $this->uri->segment(1) == $row->slug ? 'Selected' : ''; ?>>
                      <?php echo $row->page_name; ?>
                    </option>
                    <?php } ?>
                  </select>
              ...
              <div class="form-group">
                <div class="ps-checkbox pl-20">
                  <input class="form-control " type="checkbox" id="remember-me" name="remember-me" value checked
                    disabled>
                  <label for="remember-me">By submitting this form, I agree to the <a href="<?php echo base_url('term-and-condition/'); ?>"
