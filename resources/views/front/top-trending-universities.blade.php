          ...
          <div class="ps-carousel--nav owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="10000" data-owl-gap="20" data-owl-nav="true" data-owl-dots="false" data-owl-item="4" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="4" data-owl-item-lg="4" data-owl-item-xl="4" data-owl-duration="1000" data-owl-mousedrag="on">
            ...
            ?>
              <article class="ps-block--store mb-10">
                <div class="ps-block__thumbnail bg--cover" data-background="<?php echo url($row->bannerpath); ?>"></div>
                <div class="ps-block__content">
                  <div class="ps-block__author">
                    <a class="ps-block__user" style="height:60px!important" href="<?php echo url($row->country_slug . '/' . $row->uname); ?>/">
                      <img src="<?php echo url($row->imgpath); ?>" alt="<?php echo $row->name; ?>" style="height:100px!important;border:3px solid #0047ab;border-radius: 100%;" loading="lazy">
                    </a>
                  </div>
