...
@section('main-section')
  ...
  <section class="onlineCoaching ">
    <div class="container">
      <div class="row">
        <div class="col-xl-5 col-lg-5 col-md-5 col-sm-6 col-12"><img src="{{ cdn('/front/') }}/img/who-we-are.webp"
    ...
    <div class="container" style="padding:30px 15px 0px">
      ...
      <div class="row pt-10">
        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
          <a href="{{ url('medical-universities') }}/">
            <div class="ps-block--category">
              ...
              <img src="{{ url('front') }}/img/find-university.webp" alt="All Universities"
        ...
        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
          <a href="{{ url('services') }}/">
            <div class="ps-block--category">
              ...
              <img src="{{ url('front') }}/img/top-courses.webp" alt="Services" style="width:100%!important">
        ...
        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
          <a href="{{ url('destinations') }}/">
            <div class="ps-block--category">
              ...
              <img src="{{ url('front') }}/img/exams.webp" alt="All Destinations" style="width:100%!important">
        ...
        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
          <a href="{{ url('blog') }}/">
            <div class="ps-block--category">
              <img src="{{ url('front') }}/img/news.webp" alt="latest news" style="width:100%!important">
        ...
        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
          <a href="<?php echo url('mbbs-abroad-counselling'); ?>/">
            <div class="ps-block--category">
              <img src="<?php echo url('front'); ?>/img/scholarship.webp" alt="Enquire Now" style="width:100%!important">
        ...
        @foreach ($destinations as $row)
          <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12 mb-4">
            <div class="ps-post ps-product shadow">
              <div class="ps-post__thumbnail"><img src="{{ cdn($row->destination_image ?? $row->thumbnail) }}"
              ...
              <div class="col-12 col-sm-6 col-lg-6 mb-4 ">
                <div class="card more-students">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text">Tutelage Study helped me choose the right university within budget. The
                      admission process was seamless.
                    </p>
                  </div>
                </div>
              </div>
              <div class="col-12 col-sm-6 col-lg-6 mb-4 ">
                <div class="card more-students">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text main-flex ads"><i class="fa fa-graduation-cap" aria-hidden="true"></i>Eurasian
                      Medical University, Kazakhstan </p>
                    <p class="card-text ">Choosing Eurasian Medical University through Tutelage Study was the best
                      decision of my life. From university selection to visa and academic support, the team guided me like
                      family. Today, I proudly wear the white coat as Dr. Riyaz, all thanks to their dedication and expert
                      counselling.
                    </p>
              ...
              <div class="col-12 col-sm-6 col-lg-6 mb-4 ">
                <div class="card more-students">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text ads mb-0 main-flex"><i class="fa fa-graduation-cap" aria-hidden="true"></i>
                      Karshi State Medical University, Uzbekistan</p>
                    <p class="card-text ads main-flex"><i class="fa fa-check-square" aria-hidden="true"></i> NEET 2023
                      | 100% Documentation Support</p>
                    <p class="card-text">Thanks to the Tutelage counsellors for the timely visa support and expert
              ...
              <div class="col-12 col-sm-6 col-lg-6 mb-4 ">
                <div class="card more-students">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text ads mb-0 main-flex "><i class="fa fa-graduation-cap" aria-hidden="true"></i>
                      Zermed University, Uzbekistan</p>
                    <p class="card-text ads  main-flex"><i class="fa fa-check-square" aria-hidden="true"></i>
                      Low Budget | English Medium Program</p>
                    <p class="card-text">Working with Tutelage Study has been seamless; their dedication and accuracy
                      help students confidently begin their journey at SEGi University.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div class="col-12 col-md-6 counselling-right">
          <div class="counselling-content">
            <ul>
              <li>
                <div>
                  <span class="counselling-right-image"><img src="{{ cdn('front/') }}/img/Cicon1.webp"
              ...
              <li>
                <div>
                  <span class="counselling-right-image"><img src="{{ cdn('front/') }}/img/Cicon2.webp"
                      alt="Conselling Icon"></span>
                  <p>Expert <br>
                    Career Counsellors
                  </p>
              ...
              <li>
                <div>
                  <span class="counselling-right-image"><img src="{{ cdn('front/') }}/img/Cicon3.webp"
                      alt="Conselling Icon"></span>
                  <p>100% Online <br>
                    Process
                  </p>
              ...
              <li>
                <div>
                  <span class="counselling-right-image"><img src="{{ cdn('front/') }}/img/Cicon4.webp"
                      alt="Conselling Icon"></span>
                  <p>Visa<br />
                    Assistance
                  </p>
              ...
              <li>
                <div>
                  <span class="counselling-right-image"><img src="{{ cdn('front/') }}/img/Cicon5.webp"
                      alt="Conselling Icon"></span>
                  <p>Forex <br>
                    Assistance
                  </p>
              ...
              <li>
                <div>
                  <span class="counselling-right-image"><img src="{{ cdn('front/') }}/img/Cicon6.webp"
                      alt="Conselling Icon"></span>
            ...
            @foreach ($news as $row)
              <div class="ps-post ps-product">
                <div class="ps-post__thumbnail ">
                  <img src="{{ cdn($row->imgpath) }}" alt="{{ $row->headline }}"
