              ...
              <div class="ps-product-group">
                ...
                <div class="ps-product--horizontal">
                  <div class="ps-product__thumbnail"> <a
                      href="<?php echo url($tu->country_slug . '/' . $tu->uname); ?>/"> <img
                        src="<?php echo url($tu->imgpath); ?>" alt="<?php echo $tu->name; ?>"> </a> </div>
                  <div class="ps-product__content"> <a class="ps-product__title"
                      href="<?php echo url($tu->country_slug . '/' . $tu->uname); ?>/">
                      <?php echo $tu->name; ?>
                    </a> </div>
                </div>
                @endforeach
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="cur-conver">
          ...
          <p class="">Check the currency rates against all the world currencies here. The currency converter below is
          ...
          <div class="ps-post ps-product">
            ...
            <div class="ps-post__content">
              <div class="ps-post__meta">
                <a href="<?php echo url('category/' . $row->cate_slug); ?>/">
