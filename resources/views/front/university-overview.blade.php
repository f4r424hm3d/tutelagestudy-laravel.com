              ...
              <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                  ...
                  <div class="show-more-box">
                    <div class="text show-more-height">
                      <div class="ps-document">
                        ...
                        <center>
                          <img src="<?php echo asset($row->imgpath); ?>" alt="<?php echo $row->h; ?>"
                ...
                <div class="ps-product__box mb-20">
                  <div class="show-more-box">
                    ...
                    <div><a
                        href="<?php echo url(Request::segment(1) . '/' .Request::segment(2) . '/' . $row->tab_slug); ?>"
                        class="read-more">Read More <i class="fa fa-external-link"></i></a></div>
                  </div>
                </div>
                @endforeach
                        ...
                        <div class="row author">
                          <div class="col-md-2">
                            <div class="img-div"> <img
                                src="<?php echo asset($university->getAuthor->profile_pic_path); ?>"
                                alt="<?php echo $university->getAuthor->name; ?>"><i class="fa fa-check-circle"></i>
                            </div>
                          </div>
                          <div class="col-md-10">
                            <div class="cont-div">
                              ...
                              <br>
                              <?php } ?>
                              <a style="float:right" href="<?php echo url('author/'.$university->getAuthor->slug); ?>/"
