...
$wrdseo = array('id !=' => 0, 'url' => 'coursedetailpage');

$dseo = $this->mm->getAllData9($wrdseo, 'default_seos');



$c_slug = str_replace('-', ' ', $ucd->slug);

$sub_slug = str_replace('-', ' ', $ucd->sub_slug);

$level = strtolower(str_replace('-', ' ', $ucd->level));

$uname = str_replace('-', ' ', $ucd->uname);

$site =  'tutelagestudy.com';



$meta_title = $ucd->meta_title;
...
$meta_title = str_replace('%title%', $c_slug, $meta_title);

$meta_title = str_replace('%specialization%', $sub_slug, $meta_title);

$meta_title = str_replace('%universityname%', $uname, $meta_title);

$meta_title = str_replace('%level%', $level, $meta_title);
...
$meta_keyword = str_replace('%title%', $c_slug, $meta_keyword);

$meta_keyword = str_replace('%specialization%', $sub_slug, $meta_keyword);

$meta_keyword = str_replace('%universityname%', $uname, $meta_keyword);

$meta_keyword = str_replace('%level%', $level, $meta_keyword);
...
$page_content = str_replace('%title%', $c_slug, $page_content);

$page_content = str_replace('%specialization%', $sub_slug, $page_content);

$page_content = str_replace('%universityname%', $uname, $page_content);

$page_content = str_replace('%level%', $level, $page_content);
...
$meta_description = $ucd->meta_description;
...
$meta_description = str_replace('%title%', $c_slug, $meta_description);
...
$meta_description = str_replace('%specialization%', $sub_slug, $meta_description);

$meta_description = str_replace('%universityname%', $uname, $meta_description);

$meta_description = str_replace('%level%', $level, $meta_description);

$meta_description = str_replace('%site%', $site, $meta_description);



$ogimgpath = $university->ogimgpath;
