            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pr7">
              <div class="form-group">
                <input type="text" class="form-control u-ltr" placeholder="Enter Mobile Number"
                  data-error="Please enter a valid phone number" name="mobile" id="mobile" value="" required>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="ps-checkbox pl-20">
                ...
                <label for="remember-me">By submitting this form, I agree to the <a
                    href="https://www.tutelagestudy.com/term-and-condition/" style="color: blue;" target="_blank"
