          ...
          <div class="ps-tab-root">
            <div class="row">
              <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                <!--<div class="mb-20">-->
                <!--  <a href="https://www.britannicaoverseas.com/ielts-exam/" target="_blank" rel="noopener noreferrer"><img src="https://www.germanyadmission.com/assets/web/img/ads/ielts-coaching-banner.jpg" height="auto;" alt="ielts online coaching" class="shadow"></a>-->
                <!--</div>-->

                <div class="ps-product__box mb-20 pb-0 ps-product__thumbnail">
                  <div class="show-more-box">
                    <div class="text">
                      ...
                      <div class="ps-product__gallery">
                        <figure>
                          <div class="row lightGallery pt-10">
                            <?php
                            $tbl2 = 'university_galleries';
                            $ugallery = $this->mm->getAllData4($this->uri->segment(2), $tbl2);
                            foreach ($ugallery as $row) {
                            ?>
                            <div class="item col-md-4 col-sm-6 col-6 mb-20">
                              <a href="<?php echo base_url($row->imgpath); ?>"
                                title="<?php echo $this->uri->segment(1); ?>">
                                <img src="<?php echo base_url($row->imgpath); ?>" alt="" class="img-thumbnail"
                ...
                <div class="ps-product__box mb-20 pb-0">
                  <div class="show-more-box">
                    <div class="text">
                      ...
                      <div class="row pt-10 ps-wrapper">
                        <?php
                        $tbl2 = 'university_videos';
                        $uvideo = $this->mm->getAllData4($this->uri->segment(2), $tbl2);
                        foreach ($uvideo as $row) {
                        ?>
                        <div class="col-md-6 col-sm-6 col-12">
                          <div class="mb-20">
                            <iframe src="<?php echo $row->imgpath; ?>" style=" width:100%; height:190px"
                ...
                <div class="ps-product__box mb-20 shadow">
                        ...
                        <g id="Group_7106" data-name="Group 7106" transform="translate(8880 19752.379)">
                          ...
                          <g id="Group_7104" data-name="Group 7104" transform="translate(-12937.789 -19081.48)">
                            ...
                            <g id="Group_7097" data-name="Group 7097" transform="translate(4140.177 -645.934)"
                              ...
                              <circle id="Ellipse_541" data-name="Ellipse 541" cx="2.101" cy="2.101" r="2.101"
                                transform="translate(10.668 11.745)" fill="#fff" />

                              <circle id="Ellipse_542" data-name="Ellipse 542" cx="2.101" cy="2.101" r="2.101"
                                transform="translate(20.701 11.745)" fill="#fff" />

                              <circle id="Ellipse_543" data-name="Ellipse 543" cx="2.101" cy="2.101" r="2.101"
                                transform="translate(30.733 11.745)" fill="#fff" />
                            ...
                            <g id="Group_7098" data-name="Group 7098" transform="translate(4247.51 -670.899)"
                              ...
                              <rect id="Rectangle_6472" data-name="Rectangle 6472" width="41.284" height="27.545" rx="2"
                                transform="translate(0 0)" fill="#dceaff" />
                              ...
                              <line id="Line_603" data-name="Line 603" y1="11.392" x2="14.831"
                                transform="translate(0.667 15.265)" fill="none" stroke="#fff" stroke-miterlimit="10"
                                stroke-width="2" />

                              <line id="Line_604" data-name="Line 604" x1="14.831" y1="11.392"
                                transform="translate(25.786 15.265)" fill="none" stroke="#fff" stroke-miterlimit="10"
                                stroke-width="2" />
                            ...
                            <g id="Group_7103" data-name="Group 7103" transform="translate(4170.89 -568.989)"
                              ...
                              <g id="Group_7100" data-name="Group 7100" transform="translate(15.483 32.313)">
                                ...
                                <path id="Path_13076" data-name="Path 13076" d="M4417.514-292.851l8.361-11.277h-16.723Z"
                                  transform="translate(-4409.152 304.128)" fill="#dceaff" />
                  ...
                  <div class="row mt-10">
                    ...
                    <div class="col-6 text-center" style="padding-left:5px"><a class="ps-btn w-100"
                        style="font-size:13px!important; padding:7px 0px!important" href="#contact">TALK TO EXPERTS</a>
                    </div>
