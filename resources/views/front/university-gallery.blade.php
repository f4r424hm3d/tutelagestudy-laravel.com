          ...
          <div class="ps-tab-root">
            <div class="row">
              <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                <!--<div class="mb-20">-->
                <!--  <a href="https://www.britannicaoverseas.com/ielts-exam/" target="_blank"><img src="https://www.germanyadmission.com/assets/web/img/ads/ielts-coaching-banner.jpg" height="auto;" alt="ielts online coaching" class="shadow"></a>-->
                <!--</div>-->
                          ...
                          <div class="row lightGallery pt-10">
                            ...
                            ?>
                              <div class="item col-md-4 col-sm-6 col-6 mb-20">
                                <a href="<?php echo base_url($row->imgpath); ?>" title="<?php echo $this->uri->segment(1); ?>">
                                  <img src="<?php echo base_url($row->imgpath); ?>" alt="" class="img-thumbnail" style="width:100%; height:150px">
                                </a>
                              </div>
                            <?php } ?>
                          </div>
                      ...
                      <div class="row pt-10 ps-wrapper">
                        ...
                        ?>
                          <div class="col-md-6 col-sm-6 col-12">
                            <div class="mb-20">
                              <iframe src="<?php echo $row->imgpath; ?>" style=" width:100%; height:190px" allowfullscreen=""></iframe>
                            </div>
                          </div>
                        <?php } ?>
                      </div>
              ...
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                ...
                <div class="ps-product__box mb-20 shadow" style="padding:5px!important">
                  ...
                  <div class="row" style="margin-top:5px">
                    <div class="col-12 text-center"><a class="ps-btn w-100" style="background:#045dab; font-size:13px!important; padding:7px 0px!important" href="https://www.britannicaoverseas.com/ielts-online-coaching/" rel="nofollow sponsored" target="_blank">APPLY NOW</a></div>
                  </div>
                </div>
                <div class="ps-product__box mb-20 shadow" style="padding:5px!important">
                  <div class="row">
                  ...
                  <div class="row" style="margin-top:5px">
                    <div class="col-12 text-center"><a class="ps-btn w-100" style="background:#045dab; font-size:13px!important; padding:7px 0px!important" href="https://www.britannicaoverseas.com/oet-exam/" rel="nofollow sponsored" target="_blank">APPLY NOW</a></div>
                  </div>
                </div>
              </div>
            </div>
