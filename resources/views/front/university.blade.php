        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
          <div class="ps-block--recent-viewed">
            ...
            <div class="row filter-hdr">
              <?php if (isset($_SESSION['unifilter_instype'])) { ?>
                <a href="javascript:void(0)" onclick="removeAppliedFilter('unifilter_instype')"><?php echo $instDet->type; ?> <span>×</span></a>
              <?php } ?>
            </div>
          </div>
        </div>
              ...
              <div class="ps-layout__right">
                <div class="ps-shopping ps-tab-root">
                  ...
                  <div class="ps-shopping__header">
                    <p>Found<strong> <?php echo $totaluniofrcrs; ?></strong> Universities</p>
                  </div>
                  <div class="ps-tabs">
                    <?php
                      ...
                      <div class="ps-tab active" id="tab-2">
                        <div>
                          <div class="ps-product ps-product--wide">
                            <div class="ps-product__thumbnail universitylogo text-center col-md-2 col-sm-12 col-xs-12"><img src="<?php echo base_url($key->imgpath); ?>" alt="u<?php echo $key->name; ?>"> </div>
                            <div class="ps-product__container col-md-7 col-sm-12 col-xs-12">
                              <div class="ps-product__content">
                                <a class="ps-product__title b" href="<?php echo base_url($key->country_slug . '/' . $key->uname); ?>">
                                  <h5><?php echo $key->name; ?></h5>
                                </a>
                                <p>
                                  <i class="fa fa-university"></i><span> <?php echo $instType->type; ?></span>
                                </p>
                              </div>
                            </div>
                            <div class="ps-product__container col-md-3 col-sm-12 col-xs-12 text-center">
                              <p style="margin:0px">
                                <!-- <a target="_blank" class="ps-btn w-100" style="background:#0047ab" href="<?php echo base_url($key->uname . '/write-review'); ?>"><i class=" fa fa-comments"></i> Write review</a> -->
                    ...
                    <div class="ps-pagination">
                      ...
                      ?>
                        <ul class="pagination">
                          <?php if ($ppage > 0) { ?>
                            <li class="page-item"><a class="page-link " href="javascript:void()" onclick="myfunction(<?php echo $ppage; ?>)"><i class="icon-chevron-left"></i></a></li>
                          <?php } ?>

                          <?php if ($b1 > 0) { ?>
                            <li class="page-item"><a class="page-link " href="javascript:void()" onclick="myfunction(<?php echo $b1; ?>)"><?php echo $b1; ?></a></li>
                          <?php } ?>
                          <?php if ($b2 > 0) { ?>
                            <li class="page-item"><a class="page-link " href="javascript:void()" onclick="myfunction(<?php echo $b2; ?>)"><?php echo $b2; ?></a></li>
                          <?php } ?>
                          <?php if ($b3 > 0) { ?>
                            <li class="page-item active"><a class="page-link " href="javascript:void()" onclick="myfunction(<?php echo $b3; ?>)"><?php echo $b3; ?></a></li>
                          <?php } ?>
                          <?php if ($b4 <= $tp) { ?>
                            <li class="page-item"><a class="page-link " href="javascript:void()" onclick="myfunction(<?php echo $b4; ?>)"><?php echo $b4; ?></a></li>
                          <?php } ?>
                          <?php if ($b5 <= $tp) { ?>
                            <li class="page-item"><a class="page-link " href="javascript:void()" onclick="myfunction(<?php echo $b5; ?>)"><?php echo $b5; ?></a></li>
                          <?php } ?>
                          <?php if ($npage <= $tp) { ?>
                            <li class="page-item"><a class="page-link " href="javascript:void()" onclick="myfunction(<?php echo $npage; ?>)"><i class="icon-chevron-right"></i></a></li>
                          <?php } ?>
                        </ul>
                      <?php } ?>
                    </div>
          ...
          <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
              <div class="form-group">
                <input type="text" name="name" id="name" class="form-control" placeholder="Enter Name" value="<?php echo $old['name']; ?>" required>
                <?php
                if (!empty($error['name'])) {
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
              <div class="form-group">
                <input type="email" class="form-control" name="email" id="email" value="<?php echo $old['email']; ?>" placeholder="Enter Email" required>
                <?php
            ...
            <div class="col-4 col-lg-4 col-md-4 col-sm-4 col-xs-6" style="padding-right:0px">
              <div class="form-group">
                <select class="form-control" name="c_code" id="c_code" required>
                  ...
                  ?>
                    <option value="<?php echo $row->phonecode; ?>" <?php echo $curCountry == $row->phonecode || $old['c_code'] == $row->phonecode ? 'Selected' : ''; ?>> +<?php echo $row->phonecode; ?> (<?php echo $row->name; ?>)</option>
                  <?php } ?>
                </select>
                <?php if ($error['c_code']) { ?>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
              <div class="form-group">
                <select class="form-control" name="destination" id="destination" required>
                  ...
                  ?>
                    <option value="<?php echo $row->page_name; ?>" <?php echo $old['destination'] == $row->page_name || $this->uri->segment(1) == $row->slug ? 'Selected' : ''; ?>><?php echo $row->page_name; ?></option>
                  <?php } ?>
                </select>
            ...
            <div class="form-group">
              <div class="ps-checkbox pl-20">
                ...
                <label for="remember-me">By submitting this form, I agree to the <a href="<?php echo base_url('term-and-condition/'); ?>" style="color: blue;" target="_blank">terms & conditions</a></label>
              </div>
            </div>
