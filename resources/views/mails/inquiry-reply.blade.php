          ...
          <tr>
            <td valign="top" align="center" class="masthead" style="padding:20px 0;background:#03618c;color:white;">
              <h1 style="font-size:32px;margin:0 auto;max-width:90%;line-height:1.25;">
                <a href="https://wwww.tutelagestudy.com" target="_blank" style="text-decoration:none;color:#ffffff;">Tutelage Study</a>
          ...
          <tr>
            <td valign="top" class="content" style="background:white;padding:20px 35px 10px 35px;">
              ...
              <p style="text-align: justify">
                Thank you for your interest in <span style="color: black; font-weight: bold;"><?php print $destination; ?></span>. One of our admission counsellors will be in touch with you shortly.
                <br>
                <br>
                <br>
                In case of any queries, feel free to contact us at <span style="color: #fcb709;font-weight:bold">info@tutelagestudy.com</span>
              </p>
              <hr>
              <!-- <p style="text-align: justify">
