          ...
          <tr>
            <td valign="top" class="content" style="background:white;padding:20px 35px 10px 35px;">
              ...
              <p style="text-align: justify">
                Thank you for your interest in <span style="color: black; font-weight: bold;"><?php print $question; ?></span>. One of our admission counsellors will be in touch with you shortly.
                <br>
                <br>
                <br>
