...
class UniversityProfileFc extends Controller
{
  public function index(Request $request)
  {
    ...
    $data = compact('university','overview','page_url','uri3','title','site','meta_title','meta_keyword','meta_keyword','page_content','meta_description','og_image_path','destinations','toptenuni','gc','allcont','countries','phonecodes');
